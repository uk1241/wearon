...
urlpatterns = [
    ...
    path("expenses/company/new/", views.company_expense_create, name="company-expense-create"),
    path("expenses/company/<int:pk>/delete/", views.company_expense_delete, name="company-expense-delete"),
